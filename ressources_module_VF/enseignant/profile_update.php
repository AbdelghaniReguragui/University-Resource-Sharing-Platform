...
include('session.php');
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "SELECT * FROM enseignant WHERE id_enseignant = ? AND password = ?";
            ...
            <table class="table border border-dark">
                ...
                <tbody class="thead-dark">
                    ...
                    <tr>
                        ...
                        <td class="col-sm-3" scope="col"><?php echo $nom_enseignant; ?></th>
                    ...
                    <tr>
                        ...
                        <td class="col-sm-3" scope="col"><?php echo$prenom_enseignant; ?></th>
